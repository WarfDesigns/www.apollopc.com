...
(function($) {
    ...
    $.googlePlaces = function(element, options) {
        ...
        var defaults = {
              placeId: 'ChIJf1ntuIc9ZogRxETcpBLWsFM',
              render: ['reviews'],
              min_rating: 0,
              max_rows: 0,
        ...
        plugin.init = function() {
          ...
          $element.html("<div id='" + plugin.settings.map_plug_id + "'></div>");
          ...
          if (element instanceof jQuery) {
            ...
            try {
              ...
              if (ele.length) {
                ...
                throw 'Element [' + element + '] couldn’t be found in the DOM.';
              }
            } catch (e) {
              console.warn(e);
            }
        ...
        var renderReviews = function(reviews) {
          ...
          for (var i = row_count; i >= 0; i--) {
            ...
            var name = plugin.settings.shorten_names
                ? shorten_name(reviews[i].author_name)
                : reviews[i].author_name + "</span><span class='review-sep'>, </span>";

            html += "<div class='review-item'><div class='review-meta'><span class='review-author'>" + name +
                    "<span class='review-date'>" + date + "</span></div>" + stars +
